...
moviesListName.push("Batman Dark Knight");
...
moviesListName.push("Interstellar");
...
moviesListName.push("Schindler's List");
...
moviesListName.push("Inception");

for (let i = 0; i < moviesListImage.length; i++) {
    document.write(`<img src = "${moviesListImage[i]}" >`);
    
    document.write(`${moviesListName[i]}`);
}
